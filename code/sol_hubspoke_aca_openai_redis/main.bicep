...
module openAI 'modules/openai.bicep' = {
  ...
  module gpt35Turbo 'modules/openai-gpt.bicep' ={
    name: 'GPT-${appname}-deployment'
    params:{
      openAiName: '${appname}-${suffix}'
      deploymentName: 'Testgpt35'
    }
    dependsOn:[
      openAI
    ]
  ...
  module openAIPrivateDNSZone 'modules/private-dns-zone.bicep'= {
  ...
  module PEOpenAI 'modules/private-endpoint.bicep'={
    ...
    params: {
      ...
      subresource: 'account'
      snetId: acaNetwork.outputs.servicesSubnetID
    }
  }
...
// ---- Deploying redis cache ----
  ...
  module redisprivatenetworking 'modules/privatenetworking.bicep' = {
    name: 'redis-privateendpoint-deployment'
    params:{
      location: location
      azServiceId: redis.outputs.resourceId
      azServicePrivateDnsZoneName: redisPrivateDnsZoneNames
      privateEndpointName: 'pe-redis'
